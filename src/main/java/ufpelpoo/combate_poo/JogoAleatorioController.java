...
public class JogoAleatorioController extends AleatorioController {
    ...
    public static boolean getGanhouVermelho(){
    ...
    void onGridClick(MouseEvent event) throws IOException{
        ...
        if (dicaFlag == 1) {
            ...
            if (gridFlag == 0) { //seleciona a linha e coluna do personagem que fará a jogada
                ...
                if (getGanhouAzul() == true) {
                    terminaJogo(event);
                } else {
                    if (getGanhouVermelho() == true) {
                        terminaJogo(event);
                    }
                }
            }
    ...
    public void terminaJogo(MouseEvent event) throws IOException {
            FXMLLoader fxmlLoader = new FXMLLoader(MainApplication.class.getResource("FimAleatorioScene.fxml"));
